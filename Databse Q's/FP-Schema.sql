...
(
    ...
    FOREIGN KEY (`AirlineCode`, `FlightNumber`, `DepartureTime`, `ClassCode`,
                 `TicketCode`) REFERENCES `Availability` (`AirlineCode`, `FlightNumber`, `DepartureTime`, `ClassCode`,
                                                          `TicketCode`),
    FOREIGN KEY (`AirlineCode2`, `FlightNumber2`, `DepartureTime2`, `ClassCode2`,
                 `TicketCode2`) REFERENCES `Availability` (`AirlineCode`, `FlightNumber`, `DepartureTime`, `ClassCode`,
                                                           `TicketCode`),
    FOREIGN KEY (`AirlineCode3`, `FlightNumber3`, `DepartureTime3`, `ClassCode3`,
                 `TicketCode3`) REFERENCES `Availability` (`AirlineCode`, `FlightNumber`, `DepartureTime`, `ClassCode`,
                                                           `TicketCode`),
    FOREIGN KEY (`AirlineCode4`, `FlightNumber4`, `DepartureTime4`, `ClassCode4`,
                 `TicketCode4`) REFERENCES `Availability` (`AirlineCode`, `FlightNumber`, `DepartureTime`, `ClassCode`,
                                                           `TicketCode`)
