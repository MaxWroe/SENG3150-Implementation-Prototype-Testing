...
CREATE TABLE `Booking` (
                           ...
                           `Departure2` varchar(30) NOT NULL,
                           ...
                           `Departure3` varchar(30) NOT NULL,
                           `ArrivalTime3` datetime NOT NULL,
                           `Price3` int(10),
                           ...
                           `ClassCode4`char(3),
                           `TicketCode4` char(1),
                           `Destination4` varchar(30) NOT NULL,
                           `Departure4` varchar(30) NOT NULL,
                           `ArrivalTime4` datetime NOT NULL,
                           `Price4` int(10),
